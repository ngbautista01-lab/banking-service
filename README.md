...
- el seed crea clientes, cuentas, tasas de cambio y transacciones de ejemplo
- incluye datos en `DOP`, `USD` y `EUR`
- cuando aplica, tambien crea registros en `transaction_exchange_details`
- puede ejecutarse despues de `npm run migration:run`
